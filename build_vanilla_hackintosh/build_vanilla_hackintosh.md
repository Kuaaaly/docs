...
![\]](https://github.com/Kuaaaly/docs/blob/master/build_vanilla_hackintosh/images/diskutil_list.png)
3. Identifier votre clé USB (réparable grâce à sa capacité) soyez très prudent car nous allons effacer la clé. Dans mon cas, il s'agit du `disk3` donc `/dev/disk3`.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxODQ4OTk5MCwxOTkzNDI0ODQ5LDExNz
czOTQ1MzddfQ==
-->